...
Cenário: Pesquisar cliente por Nome
    ...
    E realizo uma busca de cliente por nome <Nome>
	  Então encontro o nome do cliente com sucesso <Nome>
...
Esquema do Cenario: Botão Próximo
...
Esquema do Cenario: Cálculo parcelado
    Dado que esteja com perfil logado
    Quando realizo uma busca por <nome> , <id> , <CPF> ou <Contrato> 
    E seleciono um título à pagar
...
Esquema do Cenario: Aplicação de descontos
    Dado que esteja com perfil logado
    Quando realizo uma busca por <nome> , <id> , <CPF> ou <Contrato>
    E seleciono um título à pagar
    Então  o sistema aponta o desconto disponível

Esquema do Cenario: Gravação de cálculo
    Dado que esteja com perfil logado
    Quando realizo uma busca por <nome> , <id> , <CPF> ou <Contrato>
    E seleciono um título à pagar
...
Esquema do Cenario: Abertura de cálculo gravado
    Dado que esteja com perfil logado
    Quando realizo uma busca por <nome> , <id> , <CPF> ou <Contrato>
    Então  clico no combo <operações>
...
Esquema do Cenário: Geração de boleto (com impressão)
    Dado que esteja com perfil logado
    Quando realizo uma busca por <nome> , <id> , <CPF> ou <Contrato>
    E seleciono um título à pagar
    Entao e apresentado com sucesso

Esquema do Cenário: Listar boletos (Tela de Boletos)
    Dado que esteja com perfil logado
    Quando realizo uma busca por <nome> , <id> , <CPF> ou <Contrato>
